...
rem ---------------------------------------------------------------------------
rem SCRIPT: RustDesk_Setup_x64.bat
rem DESCRIPTION: Downloads and installs RustDesk v1.4.5 remote desktop client.
rem              Auto-detects x86/x64 and fetches the correct build
rem              from official RustDesk GitHub releases.
