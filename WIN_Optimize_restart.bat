...
rem ---------------------------------------------------------------------------
rem SCRIPT: WIN_Optimize_restart.bat
rem DESCRIPTION: Windows Ultimate New PC Optimizer v2026.
rem              Performs 15 optimization tasks:
rem              1. Reserved Storage     2. Hibernation
rem              3. Background Services  4. SSD Optimization
rem              5. Visual Effects       6. Temp Folder Cleanup
rem              7. Disk Cleanup         8. Network Task Offload Fix
rem              9. Ultimate Power Plan  10. Delivery Optimization
rem              11. Telemetry Disable   12. DISM RestoreHealth
rem              13. WinSxS Cleanup      14. SFC Scannow
rem              15. CompactOS Compression
rem              Checks for pending reboot before running heavy system tasks.
rem REQUIRES: Administrator privileges
rem WARNING:  Steps 12-14 (DISM/SFC) take 10-30 minutes depending on system.
rem ---------------------------------------------------------------------------
...
cls
echo %Y%================================================================================%X%
echo %B% WINDOWS ULTIMATE NEW PC OPTIMIZER v2026.07.11%X%
echo %Y%================================================================================%X%
...
echo %Y%================================================================================%X%
echo.
echo = Rooted by VladiMIR + AI | v.2026.07.11 | github.com/GinCz =
echo.
