...
echo ==========================================================================================
echo   GitHub Desktop Installer   ^|   Run as Administrator   ^|   CMD Script
echo ==========================================================================================
echo.
...
set "filename=GitHubDesktopSetup-x64.exe"
...
if "%is_64%"=="0" (
    set "download_url=https://central.github.com/deployments/desktop/desktop/latest/win32msi"
    set "filename=GitHubDesktopSetup-x86.exe"
...
set "new_dir=C:\Windows\Temp\github_dynamic_session_%RANDOM%_%RANDOM%_%RANDOM%"
mkdir "%new_dir%" 2>nul
