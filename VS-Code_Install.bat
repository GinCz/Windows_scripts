...
rem ---------------------------------------------------------------------------
rem SCRIPT: VS-Code_Install.bat
rem DESCRIPTION: Downloads and installs VS Code User Setup v1.118.1.
rem              Auto-detects x86/x64, downloads from Microsoft servers,
rem              unblocks the file and launches the installer silently.
