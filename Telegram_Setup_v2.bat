...
rem ---------------------------------------------------------------------------
rem SCRIPT: Telegram_Setup_v2.bat
rem DESCRIPTION: Downloads and installs the latest Telegram Desktop.
rem              Auto-detects x86/x64 and fetches the correct build
rem              from official Telegram servers.
...
echo ==========================================================================================
echo L O A D I N G ^| Universal Telegram Desktop Stable Installer Downloader
echo ==========================================================================================
echo.
...
echo * It automatically fetches the LATEST stable release from official Telegram servers.
...
set "new_dir=C:\Windows\Temp\telegram_dynamic_session_%RANDOM%_%RANDOM%_%RANDOM%"
mkdir "%new_dir%" 2>nul

set "download_path=%new_dir%\%filename%"

echo [+] Downloading the latest installer version from official Telegram servers...
echo.
echo ==========================================================================================
