...
rem ---------------------------------------------------------------------------
rem SCRIPT: MEGA_x64_x86_Setup.bat
rem DESCRIPTION: Downloads and installs the latest MEGA Sync client.
rem              Auto-detects x86/x64 and downloads the correct build
rem              from official MEGA servers (replaces old x86-only script).
...
echo ==========================================================================================
echo L O A D I N G ^| Universal MEGA Stable Installer Downloader
echo ==========================================================================================
echo.
...
rem Default fallback to 32-bit architecture
set "download_url=https://mega.nz/MEGAsyncSetup32.exe"
set "filename=MEGAsyncSetup32.exe"
set "arch_type=x86 (32-bit)"

if "%PROCESSOR_ARCHITECTURE%"=="AMD64" set "arch_type=x64 (64-bit)"
if "%PROCESSOR_ARCHITEW6432%"=="AMD64" set "arch_type=x64 (64-bit)"

if "%arch_type%"=="x64 (64-bit)" (
...
echo * It automatically fetches the LATEST stable release from official MEGA servers.
...
echo [+] Downloading the latest installer version from official MEGA servers...
echo.
echo ==========================================================================================
