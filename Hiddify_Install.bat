...
echo ==========================================================================================
echo   Hiddify VPN Installer   ^|   Run as Administrator   ^|   CMD Script
echo ==========================================================================================
echo.
...
if "%is_64%"=="0" (
    set "download_url=https://github.com/hiddify/hiddify-app/releases/latest/download/Hiddify-Windows-Setup-x86.exe"
    set "filename=Hiddify-Windows-Setup-x86.exe"
