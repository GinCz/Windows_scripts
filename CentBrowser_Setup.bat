...
echo ==========================================================================================
echo   CentBrowser Installer   ^|   Run as Administrator   ^|   CMD Script
echo ==========================================================================================
echo.
...
set "download_url=https://www.centbrowser.net/release/centbrowser_latest_x64.zip"
set "filename=centbrowser_latest_x64.zip"
...
if "%is_64%"=="0" (
    set "download_url=https://www.centbrowser.net/release/centbrowser_latest.zip"
    set "filename=centbrowser_latest_x86.zip"
...
echo [+] Downloading from official CentBrowser servers...
echo.
echo ==========================================================================================
