...
if "%is_64%"=="0" (
set "download_url=https://laptop-updates.brave.com/latest/winia32"
set "filename=BraveBrowserSetup_x86.exe"
...
echo * It automatically fetches the LATEST stable release from official Brave servers.
...
echo [+] Downloading the latest installer version from official Brave servers...
echo.
echo ==========================================================================================
